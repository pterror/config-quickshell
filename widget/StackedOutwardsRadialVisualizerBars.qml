		...
		Item {
			...
			Repeater {
				...
				Rectangle {
					...
					x: root.width / 2 + (root.innerRadius + cumulative * root.scale + implicitHeight) * xMultiplier - barWidth / 2
					y: root.height / 2 + (root.innerRadius + cumulative * root.scale + implicitHeight) * yMultiplier
